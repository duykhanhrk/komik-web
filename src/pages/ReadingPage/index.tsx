    ...
    <>
      {query.isLoading
        ...
        : query.isError
          ...
          : 
          <>
            {query.data?.image_urls?.length !== 0
              ? query.data?.image_urls?.map((item: string) => (
                <Card key={item} style={{padding: 0, backgroundColor: 'transparent'}} animation="slideTopIn">
                  <img src={item} />
                </Card>
              ))
